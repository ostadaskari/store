    ...
    <style>
        @media print {
            ...
            * {
            ...
            .badge-discount { border: 1px solid #000 !important; color: #000 !important; background: transparent !important; }
            .original-price-strikethrough { text-decoration: line-through !important; color: #666 !important; font-size: 0.8rem; }
        }
