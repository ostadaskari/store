...
<head>
    ...
    <title>تکمیل ثبت نام | شماره موبایل</title>
...
<div class="registration-box">
    ...
    <div class="w-100">
        ...
        @if ($step == 1)
            <!-- STEP 1: MOBILE NUMBER INPUT (Social Completion) -->
            <div class="verify-header">
                <h3 class="verify-title">تکمیل ثبت نام</h3>
                <div class="create-description">
                    <span dir="ltr">{{ $email }}</span>
                    شما از طریق شبکه‌های اجتماعی وارد شدید. لطفاً برای تکمیل حساب کاربری، شماره موبایل خود را وارد کنید.
                </div>
            </div>

            <form action="{{ route('client.social.send.code') }}" method="POST" class="verify-form-container">
                @csrf
                ...
                <button class="btn-primary" type="submit">ارسال کد تایید و تکمیل</button>

                <div class="create-terms-section">
                    <p>
                        <a href="{{ route('client.login.mobile.form') }}" style="color: var(--primary-blue); text-decoration: none; font-weight: bold;">لغو و بازگشت به صفحه ورود</a>
                    </p>
                </div>
            </form>

        @elseif ($step == 2)
            <!-- STEP 2: OTP VERIFICATION (Social Completion) -->
            <div class="verify-header">
            ...
            <form action="{{ route('client.social.verify.code') }}" method="POST" class="verify-form-container" id="otp-form">
                @csrf
                ...
                <div class="change-mobile-link">
                    <!-- Linking back to the mobile input form for social completion -->
                    <a href="{{ route('client.social.complete.mobile', ['step' => 1]) }}"
                       style="color: var(--primary-blue); text-decoration: none;">تغییر شماره موبایل</a>
                </div>

                <button class="btn-primary" type="submit">تایید و ورود نهایی</button>
        ...
        @else
            ...
            <div class="verify-header">
                ...
                <div class="create-description">خطای جریان تکمیل ثبت‌نام. لطفاً
...
<!-- Custom Modal/Message Box (For OTP errors) -->
...
<!-- Three.js Background Script (Copied from Register) -->
<script type="module">
