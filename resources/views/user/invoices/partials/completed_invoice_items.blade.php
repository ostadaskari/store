...
{{ $statusText }}
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-header justify-content-between">
                        ...
                        <h5 class="modal-title" id="invoiceModalLabel-{{ $invoice->id }}">فاکتور نهایی: #{{ $invoice->order_number }}</h5>
                    </div>
                    <div class="modal-body pt-0">
                        <div class="container-fluid py-3" dir="rtl">
                            <div class="seven mt-3">
                                <h1>جزئیات فاکتور #{{ $invoice->order_number }}</h1>
                                <p class="text-muted" style="font-size: 0.9rem;">این فاکتور با موفقیت نهایی و ارسال شده است.</p>
                            </div>
                                ...
                                <div class="col-12 col-lg-4 mb-2 colPrint">
                                    <div class="card shadow-sm h-100">
                                        ...
                                        <div class="card-body text-right">
                                            ...
                                            <p><strong>وضعیت پرداخت:</strong> <span class="badge bg-success">پرداخت شده</span></p>
                                            <p><strong>روش پرداخت:</strong> {{ $invoice->payment_method == 'credit' ? 'آنلاین' : 'نقدی (COD)' }}</p>
                                            <p><strong>وضعیت ارسال:</strong> <span class="badge bg-success">تکمیل شده</span></p>
                                        </div>
                                    </div>
                                </div>
    ...
    @empty
        <div class="alert alert-info text-center">فاکتوری در بخش بایگانی یافت نشد.</div>
    @endforelse
