                    ...
                    <div class="w-100 my-2 bg-light">
                        <div class="order-meta-grid">
                            ...
                            <div class="meta-item"><strong>وضعیت فاکتور:</strong>
                                @php
                                    // Status is assumed 'canceled' for this tab's data
                                    $statusKey = 'canceled';
                        ...
                        {{-- Canceled items don't need a progress bar, use an alert instead --}}
                        <div class="w-100 my-4 p-3 text-center alert alert-danger">
                            این فاکتور لغو شده و مراحل ارسال آن متوقف شده است.
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4 mb-2 colPrint">
                                    <div class="card shadow-sm h-100">
                                        <div class="card-header bg-danger text-white text-right">خلاصه فاکتور</div>
                                        <div class="card-body text-right">
                                            ...
                                            <p><strong>وضعیت ارسال:</strong>
                                                <span class="{{ $statusClasses['canceled'] }}">{{ $statusTexts['canceled'] }}</span>
                                            </p>
