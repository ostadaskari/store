...
<div class="col-md-3" style="overflow: visible;position: relative;">
    <div class="user-profile">
        <div class="avatar-div d-flex align-items-center flex-column">
            ...
            <picture>
                <svg  width="80" height="80" fill="#97a6bb" class="bi bi-person-circle" viewBox="0 0 16 16">
        ...
        <a href="{{ route('user.orders') }}" class="user-info-item">
        ...
        <a href="{{ route('user.invoices') }}" class="user-info-item">
        ...
        <a href="{{ route('user.profile') }}" class="user-info-item" style="border-bottom: none;">
